...
int listaConvocadosBinario(LinkedList * pListaConvocados, LinkedList* pArrayListJugador)
{
	...
	{
		  size = ll_len(pArrayListJugador);
		  respuestaConfederacion = muestraGuardarConvocados();
		  if(respuestaConfederacion==1)
		  {
			   for(int i=0; i<size; i++)
					   {
						   ...
						   if(unJugador != NULL && (idSeleccion == 2 || idSeleccion == 4 || idSeleccion == 9 || idSeleccion == 21 || idSeleccion == 22 ||
								   idSeleccion == 27 || idSeleccion == 4))
						   {
				  ...
				  for(int i=0; i<size; i++)
				   {
					   ...
					   if(unJugador != NULL && (idSeleccion == 7 || idSeleccion == 18 || idSeleccion == 23 || idSeleccion == 28 || idSeleccion == 31))
					   {
						   ll_add(pListaConvocados, unJugador);
						   retorno = 0;
					   }
					  ...
					  for(int i=0; i<size; i++)
					   {
						   ...
						   if(unJugador != NULL && (idSeleccion == 8 || idSeleccion == 10 || idSeleccion == 15 || idSeleccion == 24))
						   {
							   ll_add(pListaConvocados, unJugador);
							   retorno = 0;
						   }
						  ...
						  for(int i=0; i<size; i++)
						   {
							   ...
							   if(unJugador != NULL && (idSeleccion == 3 || idSeleccion == 6 || idSeleccion == 13 || idSeleccion == 32))
							   {
								   ll_add(pListaConvocados, unJugador);
								   retorno = 0;
							   }
						  ...
						  for(int i=0; i<size; i++)
						   {
							   ...
							   if(unJugador != NULL && (idSeleccion == 1 || idSeleccion == 5 || idSeleccion == 11 || idSeleccion == 12 || idSeleccion == 14 || idSeleccion == 16
									   || idSeleccion == 17 ||  idSeleccion == 19 || idSeleccion == 20 || idSeleccion == 25 || idSeleccion == 26 || idSeleccion == 29
									   || idSeleccion == 30))
							   {
								   ll_add(pListaConvocados, unJugador);
								   retorno = 0;
